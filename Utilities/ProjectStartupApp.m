classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "DSP-Signals-and-Filter-Design";
        ImagePath {mustBeFile} = fullfile("Images","image_10.png"); 
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.StartUpAppUIFigure.Position = [100 100 276 514];
            ...
            app.WelcomePanel.Position = [-551 117 244 410];
            ...
            app.CoverImage.ImageSource = 'image_10.png';
            ...
            app.FeedBackPanel.Position = [-291 117 236 409];
