classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Introduction-To-Digital-Signal-Processing";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Digital Signal Processing';
            ...
            app.Image.ImageSource = 'CoverImage.png';
            ...
            app.ReviewTitle.Text = 'Welcome to Digital Signal Processing';
